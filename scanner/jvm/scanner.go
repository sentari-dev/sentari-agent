...
//
// See the scanner plugin interface for the contract this package implements.
package jvm
...
// PackageRecord it emits.  On the ``jvm`` vs
// ``maven`` vs ``java`` naming distinction: the scanner identifier is
